<%@page import="com.rays.ctrl.UserCtl"%>
<%@page import="com.rays.util.HTMLUtiltiy"%>
<%@page import="java.util.HashMap"%>
<%@page import="com.rays.util.DataUtility"%>
<%@page import="com.rays.util.ServletUtility"%>
<%@page import="java.util.List"%>
<%@page import="com.rays.ctrl.ORSView"%>
			...
			<table>
				...
				<tr>
					...
					<td>
						...
						String hlist = HTMLUtiltiy.getList("gender", String.valueOf(bean.getGender()), map);
						%> <%=hlist%>
					</td>
				...
				<tr>
					...
					<td><%=HTMLUtiltiy.getList("roleId", String.valueOf(bean.getRoleId()), l)%></td>
